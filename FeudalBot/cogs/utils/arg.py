...
regex_mention = re.compile("<@(?:!|)(\d+)>") # pylint: disable=anomalous-backslash-in-string
regex_namediscrim = re.compile("(.{2,32})#(\d{4})")# pylint: disable=anomalous-backslash-in-string
regex_id = re.compile("(^\d+$)") # pylint: disable=anomalous-backslash-in-string
regex_name = re.compile("(.{2,32})") # pylint: disable=anomalous-backslash-in-string
role_mention = re.compile("<@&(\d+)>") # pylint: disable=anomalous-backslash-in-string
channel_mention = re.compile("<#(\d+)>") # pylint: disable=anomalous-backslash-in-string
